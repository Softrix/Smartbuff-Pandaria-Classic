...
SMARTBUFF_WHATSNEW = "\n\n|cffffffff         Whats new:|r\n\n"
  .."          |cffffffffMists of Pandaria version by Codermik, additional\n"
  .."          programming/fixes by Speedwaystar/MrWizard.\n"
  .."\n\n"
  .."          Changes in r70.090825:\n\n"
  .."             * Paladin seal fixes.\n"
  .."             * Paladin missing buffs added.\n"
  .."             * Monk/Warrior stances fixed.\n"
  .."             * DK presence fixed.\n"
  .."\n\n"
...
SMARTBUFF_CREDITS = "|cffffffff"
  .."\n\nRetail & Classic by Codermik, additional coding by MrWizard & Speedwaystar. Join and get support via discord:\n\n"
...
SMARTBUFF_TEMPLATES = {"Solo", "Party", "Raid", "Battleground", "Molten Core", "Onyxia’s Lair", "Blackwing Lair", "Ruins of Ahn’Qiraj", "Temple of Ahn’Qiraj", "Naxxramas", 
	"Gruul’s Lair", "Magtheridon’s Lair", "Karazhan", "Serpentshrine Cavern", "Tempest Keep", "Battle for Mount Hyjal", "Black Temple", "Sunwell Plateau", 
	"Obsidian Sanctum", "Vault of Archavon", "The Eye of Eternity", "Ulduar", "Trial of the Crusader", "Icecrown Citadel", "The Ruby Sanctum", "Baradin Hold", 
	"Bastion of Twilight", "Throne of the Four Winds", "Firelands", "Dragon Soul", "Mogu'shan Vaults", "Terrace of Endless Spring", "Heart of Fear", 
	"Throne of Thunder", "Siege of Orgrimmar", "Custom 1", "Custom 2", "Custom 3"
};
SMARTBUFF_INSTANCES = {"Molten Core", "Onyxia’s Lair", "Blackwing Lair", "Ruins of Ahn’Qiraj", "Temple of Ahn’Qiraj", "Naxxramas", "Gruul’s Lair", "Magtheridon’s Lair", 
	"Karazhan", "Serpentshrine Cavern", "Tempest Keep", "Battle for Mount Hyjal", "Black Temple", "Sunwell Plateau", "Obsidian Sanctum", "Vault of Archavon", 
	"The Eye of Eternity", "Ulduar", "Trial of the Crusader", "Icecrown Citadel", "The Ruby Sanctum", "Baradin Hold", "Bastion of Twilight", "Throne of the Four Winds", "Firelands",
	"Dragon Soul", "Mogu'shan Vaults", "Terrace of Endless Spring", "Heart of Fear", "Throne of Thunder", "Siege of Orgrimmar"
};
...
SMARTBUFF_OFT_SCROLLWHEELUP  = "Buff on scroll wheel up";
