...
SMARTBUFF_CREDITS = "|cffffffff"
  .."Codermik 的 MOP 版本。 请在 CurseForge 或我的 discord 上报告任何问题：\n\n"
...
SMARTBUFF_TEMPLATES = {"自我", "隊伍", "團隊", "戰場", "熔火之心", "奧妮克希亞的巢穴", "黑翼之巢", "安其拉废墟", "安其拉神殿", "纳克萨玛斯", 
	"格鲁尔的巢穴", "玛瑟里顿的巢穴", "卡拉赞", "毒蛇神殿", "风暴要塞", "海加尔山之战", "黑暗神殿", "太阳之井高地", 
	"黑曜石圣殿", "阿尔卡冯的宝库", "永恒之眼", "奥杜尔", "十字军的试炼", "冰冠堡垒", "红玉圣殿", "巴拉丁监狱", 
	"暮光堡垒", "风神王座", "火焰之地", "巨龙之魂", "魔古山寶庫", "豐泉台", "恐懼之心", "雷霆王座", "圍攻奧格瑪", "Custom 1", "Custom 2",
	"Custom 3"
};
SMARTBUFF_INSTANCES = {"熔火之心", "奧妮克希亞的巢穴", "黑翼之巢", "安其拉废墟", "安其拉神殿", "纳克萨玛斯", "格鲁尔的巢穴", "玛瑟里顿的巢穴",
	"卡拉赞", "毒蛇神殿", "风暴要塞", "海加尔山之战", "黑暗神殿", "太阳之井高地", "黑曜石圣殿", "阿尔卡冯的宝库",
	"永恒之眼", "奥杜尔", "十字军的试炼", "冰冠堡垒", "红玉圣殿", "巴拉丁监狱", "暮光堡垒", "风神王座",
	"火焰之地", "巨龙之魂", "魔古山寶庫", "豐泉台", "恐懼之心", "雷霆王座", "圍攻奧格瑪"
};
