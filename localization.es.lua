...
SMARTBUFF_CREDITS = "|cffffffff"
  .."Versión de MOP por Codermik. Informe cualquier problema en CurseForge o mi discordia en:\n\n"
...
-- Templates and Instances | blame wowhead if translations are wrong :)  CM
SMARTBUFF_TEMPLATES = {"Solo", "Grupo", "Banda", "Campos de batalla", "Núcleo de Magma", "Guarida de Onyxia", "Guarida de Alanegra", "Ruinas de Ahn'Qiraj", "Templo de Ahn'Qiraj", 
	"Naxxramas", "Guarida de Gruul", "Guarida de Magtheridon", "Karazhan", "Caverna Santuario Serpiente", "El Castillo de la Tempestad", "Batalla de El Monte Hyjal", "Templo Oscuro", 
	"Meseta de La Fuente del Sol", "El Sagrario Obsidiana", "La Cámara de Archavon", "El Ojo de la Eternidad", "Ulduar", "Prueba del Cruzado", "Ciudadela de la Corona de Hielo", "El Sagrario Rubí", 
	"Bastión de Baradin", "El Bastión del Crepúsculo", "Trono de los Cuatro Vientos", "Tierras de Fuego", "Alma de Dragón", "Cámaras Mogu'shan", "Veranda de la Primavera Eterna", 
	"Corazón del Miedo", "Solio del Trueno", "Asedio de Orgrimmar", "Custom 1", "Custom 2", "Custom 3"
};
SMARTBUFF_INSTANCES = {"Núcleo de Magma", "Guarida de Onyxia", "Guarida de Alanegra", "Ruinas de Ahn'Qiraj", "Templo de Ahn'Qiraj", "Naxxramas", "Guarida de Gruul", "Guarida de Magtheridon", 
	"Karazhan", "Caverna Santuario Serpiente", "El Castillo de la Tempestad", "Batalla de El Monte Hyjal", "Templo Oscuro", "Meseta de La Fuente del Sol", "El Sagrario Obsidiana", "La Cámara de Archavon", 
	"El Ojo de la Eternidad", "Ulduar", "Prueba del Cruzado", "Ciudadela de la Corona de Hielo", "El Sagrario Rubí", "Bastión de Baradin", "El Bastión del Crepúsculo", "Trono de los Cuatro Vientos", 
	"Tierras de Fuego", "Alma de Dragón", "Cámaras Mogu'shan", "Veranda de la Primavera Eterna", "Corazón del Miedo", "Solio del Trueno", "Asedio de Orgrimmar"
};
