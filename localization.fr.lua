...
SMARTBUFF_CREDITS = "|cffffffff"
  .."Version MOP par Codermik. Veuillez signaler tout problème sur CurseForge ou mon discord:\n\n"
...
SMARTBUFF_TEMPLATES = {"Seul", "Groupe", "Raid", "Champs de Bataille", "Cœur du Magma", "Repaire d'Onyxia", "Repaire de l'Aile noire", "Ruines d'Ahn'Qiraj", "Temple d’Ahn’Qiraj", 
	"Naxxramas", "Repaire de Gruul", "Le repaire de Magtheridon", "Karazhan", "Caverne du sanctuaire du Serpent", "Donjon de la Tempête", "La bataille du mont Hyjal", "Temple Noir", "Plateau du Puits de soleil", 
	"Le sanctum Obsidien", "Caveau d'Archavon", "L'Œil de l'éternité", "Ulduar", "L'épreuve du croisé", "Citadelle de la Couronne de glace", "Le sanctum Rubis", "Bastion de Baradin", "Le bastion du Crépuscule", 
	"Trône des quatre vents", "Terres de Feu", "L’Âme des dragons", "Caveaux Mogu’shan", "Terrasse Printanière", "Cœur de la peur", "Trône du tonnerre", "Siège d’Orgrimmar", 
	"Custom 1", "Custom 2", "Custom 3"
};
SMARTBUFF_INSTANCES = {"Cœur du Magma", "Repaire d'Onyxia", "Repaire de l'Aile noire", "Ruines d'Ahn'Qiraj", "Temple d’Ahn’Qiraj", "Naxxramas", "Repaire de Gruul", "Le repaire de Magtheridon", 
	"Karazhan", "Caverne du sanctuaire du Serpent", "Donjon de la Tempête", "La bataille du mont Hyjal", "Temple Noir", "Plateau du Puits de soleil", "Le sanctum Obsidien", "Caveau d'Archavon", 
	"L'Œil de l'éternité", "Ulduar", "L'épreuve du croisé", "Citadelle de la Couronne de glace", "Le sanctum Rubis", "Bastion de Baradin", "Le bastion du Crépuscule", "Trône des quatre vents", "Terres de Feu",
	"L’Âme des dragons", "Caveaux Mogu’shan", "Terrasse Printanière", "Cœur de la peur", "Trône du tonnerre", "Siège d’Orgrimmar"
};
