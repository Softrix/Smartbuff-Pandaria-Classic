...
SMARTBUFF_CREDITS = "|cffffffff"
  .."Версия MOP от Codermik. Пожалуйста, сообщайте о любых проблемах на CurseForge или в моем разногласии по адресу:\n\n"
...
-- Templates and Instances : if the russian translations are wrong, blame wowhead  ;-)   CM
SMARTBUFF_TEMPLATES = {"Соло", "Группа", "Рейд", "Поле битвы", "Огненные Недра", "Логово Ониксии", "Логово Крыла Тьмы", "Руины Ан'Киража", "Ан'Кираж", 
	"Наксрамас", "Логово Груула", "Логово Магтеридона", "Каражан", "Змеиное святилище", "Крепость Бурь", "Битва за гору Хиджал", "Черный храм", 
	"Плато Солнечного Колодца", "Обсидиановое святилище", "Склеп Аркавона", "Око Вечности", "Ульдуар", "Испытание крестоносца", "Цитадель Ледяной Короны", 
	"Рубиновое святилище", "Крепость Барадин", "Сумеречный бастион", "Трон Четырех Ветров", "Огненные Просторы", "Душа Дракона","Подземелья Могу'шан", 
	"Терраса Вечной Весны", "Сердце Страха", "Престол Гроз", "Осада Оргриммара", "Custom 1", "Custom 2", "Custom 3"
};
SMARTBUFF_INSTANCES = {"Огненные Недра", "Логово Ониксии", "Логово Крыла Тьмы", "Руины Ан'Киража", "Ан'Кираж", "Наксрамас", "Логово Груула", "Логово Магтеридона", 
	"Каражан", "Змеиное святилище", "Крепость Бурь", "Битва за гору Хиджал", "Черный храм", "Плато Солнечного Колодца", "Обсидиановое святилище", "Склеп Аркавона", 
	"Око Вечности", "Ульдуар", "Испытание крестоносца", "Цитадель Ледяной Короны", "Рубиновое святилище", "Крепость Барадин", "Сумеречный бастион", 
	"Трон Четырех Ветров", "Огненные Просторы", "Душа Дракона", "Подземелья Могу'шан", "Терраса Вечной Весны", "Сердце Страха", "Престол Гроз", "Осада Оргриммара"
};
