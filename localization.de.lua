...
SMARTBUFF_CREDITS = "|cffffffff"
  .."MOP Classic Version von Codermik. Bitte melde alle Probleme auf CurseForge oder meinem Discord unter:\n\n"
...
SMARTBUFF_TEMPLATES = {"Solo", "Gruppe", "Raid", "Schlachtfeld", "Geschmolzener Kern", "Onyxias Hort", "Pechschwingenhort", "Ruinen von Ahn'Qiraj", "Tempel von Ahn'Qiraj", 
	"Naxxramas", "Gruuls Unterschlupf", "Magtheridons Kammer", "Karazhan", "Höhle des Schlangenschreins", "Festung der Stürme", "Die Schlacht um den Hyjal", "Der Schwarze Tempel", "Sonnenbrunnenplateau",
	"Das Obsidiansanktum", "Archavons Kammer", "Das Auge der Ewigkeit", "Ulduar", "Prüfung des Kreuzfahrers", "Eiskronenzitadelle", "Das Rubinsanktum", "Baradinfestung", "Die Bastion des Zwielichts",
	"Thron der Vier Winde", "Feuerlande", "Drachenseele", "Mogu'shangewölbe", "Terrasse des Endlosen Frühlings", "Das Herz der Angst", "Der Thron des Donners",
	"Schlacht um Orgrimmar", "Custom 1", "Custom 2", "Custom 3"
};
SMARTBUFF_INSTANCES = {"Geschmolzener Kern", "Onyxias Hort", "Pechschwingenhort", "Ruinen von Ahn'Qiraj", "Tempel von Ahn'Qiraj", "Naxxramas", "Gruuls Unterschlupf", "Magtheridons Kammer",
	"Karazhan", "Höhle des Schlangenschreins", "Festung der Stürme", "Die Schlacht um den Hyjal", "Der Schwarze Tempel", "Sonnenbrunnenplateau", "Das Obsidiansanktum", "Archavons Kammer",
	"Das Auge der Ewigkeit", "Ulduar", "Prüfung des Kreuzfahrers", "Eiskronenzitadelle", "Das Rubinsanktum", "Baradinfestung", "Die Bastion des Zwielichts", "Thron der Vier Winde",
	"Feuerlande", "Drachenseele", "Mogu'shangewölbe", "Terrasse des Endlosen Frühlings", "Das Herz der Angst", "Der Thron des Donners", "Schlacht um Orgrimmar"
};
