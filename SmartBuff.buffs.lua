...
function SMARTBUFF_InitItemList()
  ...
  S.FoodItems = GetItems({
     ...
     62651, 62652, 62653, 62654, 62655, 62656, 62657, 62658, 62659, 62660, 62661, 62662, 62663, 62664, 62665, 62666, 62667, 62668, 62669, 62670, 62671, 62649, 74645, 74646, 74647, 74648, 74649, 74650, 74652, 74653, 74655, 74656,
	 86069, 86070, 86073, 86074, 81400, 81401, 81402, 81403, 81404, 81405, 81406, 81408, 81409, 81410, 81411, 81412, 81413, 81414,
  });
  ...
  SMARTBUFF_CONJUREDMANA        = C_Item.GetItemInfo(42955); --"Conjured Mana Buns"
  ...
  _,SMARTBUFF_FLASKMOP7           = C_Item.GetItemInfo(86569);  --"Crystal of Insanity"
...
function SMARTBUFF_InitSpellIDs()
  ...
  SMARTBUFF_SOULLINK        = getSpellBookItemByName(108415);--"Soul Link"
  ...
  SMARTBUFF_DARKINTENT      = getSpellBookItemByName(109773);--"Dark Intent"
  ...
  -- Shaman
  SMARTBUFF_LIGHTNINGSHIELD = getSpellBookItemByName(324);    --"Lightning Shield"
  ...
  SMARTBUFF_WINDFURYW       = getSpellBookItemByName(8232);   --"Windfury Weapon"
  SMARTBUFF_ROCKBITERW      = getSpellBookItemByName(8017);   --"Rockbiter Weapon"
  SMARTBUFF_FROSTBRANDW     = getSpellBookItemByName(8033);   --"Frostbrand Weapon"
  SMARTBUFF_FLAMETONGUEW    = getSpellBookItemByName(8024);   --"Flametongue Weapon"
  ...
  SMARTBUFF_BATSTANCE       = getSpellBookItemByName(2457);   --"Battle Stance"
  SMARTBUFF_DEFSTANCE       = getSpellBookItemByName(71);     --"Defensive Stance"
  SMARTBUFF_BESSTANCE       = getSpellBookItemByName(2458);   --"Beserker Stance"
  ...
  SMARTBUFF_SACREDSHIELD            = getSpellBookItemByName(20925);  --"Sacred Shield"
  SMARTBUFF_BOK                   = getSpellBookItemByName(20217);  --"Blessing of Kings"
  SMARTBUFF_BOM                   = getSpellBookItemByName(19740);  --"Blessing of Might"
...
--  SMARTBUFF_SOTSPIRITEDCRANE= getSpellBookItemByName(154436); --"Stance of the Spirited Crane"
  ...
  SMARTBUFF_BFLASKMOP7      = C_Spell.GetSpellInfo(127230); --"Crystal of Insanity"
...
--  SMARTBUFF_BGRFLASKWOD4    = C_Spell.GetSpellInfo(156064); --"Greater Draenic Agility Flask"
  ...
  S.LinkFlaskMoP            = { SMARTBUFF_BFLASKCT61, SMARTBUFF_BFLASKCT62, SMARTBUFF_BFLASKCT63, SMARTBUFF_BFLASKMOP2, SMARTBUFF_BFLASKMOP3, SMARTBUFF_BFLASKMOP4, SMARTBUFF_BFLASKMOP5, SMARTBUFF_BFLASKMOP6, SMARTBUFF_BFLASKMOP7 };
...
function SMARTBUFF_InitSpellList()
  ...
  if (SMARTBUFF_PLAYERCLASS == "WARLOCK") then
    SMARTBUFF_BUFFLIST = {
      ...
      {SMARTBUFF_DARKINTENT, 60, SMARTBUFF_CONST_SELF, nil, nil, nil, S.LinkSp},
  ...
  if (SMARTBUFF_PLAYERCLASS == "SHAMAN") then
    SMARTBUFF_BUFFLIST = {
      ...
      {SMARTBUFF_ROCKBITERW, 60, SMARTBUFF_CONST_WEAPON},
      {SMARTBUFF_FROSTBRANDW, 60, SMARTBUFF_CONST_WEAPON}, 
  ...
  if (SMARTBUFF_PLAYERCLASS == "WARRIOR") then
    SMARTBUFF_BUFFLIST = {
      ...
      {SMARTBUFF_BESSTANCE, -1, SMARTBUFF_CONST_SELF, nil, nil, nil, S.ChainWarriorStance}
    };
  end
  ...
  if (SMARTBUFF_PLAYERCLASS == "PALADIN") then
    SMARTBUFF_BUFFLIST = {
      ...
      {SMARTBUFF_SACREDSHIELD, 0.166, SMARTBUFF_CONST_SELF},
...
--      {SMARTBUFF_HOSAL, 0.1, SMARTBUFF_CONST_GROUP, {66}, "WARRIOR;DEATHKNIGHT;DRUID;SHAMAN;HUNTER;ROGUE;MAGE;PRIEST;PALADIN;WARLOCK;MONK;DEMONHUNTER;EVOKER;HPET;WPET;DKPET"},
  ...
  SMARTBUFF_POTION = {
    ...
    {SMARTBUFF_FLASKMOP7, 60, SMARTBUFF_CONST_POTION, nil, SMARTBUFF_BFLASKMOP7}, 
